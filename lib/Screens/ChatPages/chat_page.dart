...
// import '../../Chat/Widgets/loading_view.dart';
// import '../../Helper/Constant/color_constants.dart';
// import '../../Helper/Constant/firestore_constants.dart';
// import '../../Models/ChatModels/message_chat.dart';
// import '../../Providers/ChatProviders/chat_provider.dart';
// import '../GymOwnerScreens/members.dart';
// import 'pages.dart';
//
...
//       groupChatId ="${currentUserId.toString()+ "-" + widget.arguments.peerId}";
//       chatProvider.sendMessage(content, type, groupChatId, currentUserId.toString(), widget.arguments.peerId);
...
//     return Flexible(
//       child: AppConfig.groupChatId.isNotEmpty
